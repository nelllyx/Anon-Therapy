 ...
 */
const getOrCreateConversation = async (userId1, userModel1, userId2, userModel2, sessionId = null) => {
...
exports.sendMessage = catchAsync(async (req, res, next) => {
    ...
    if (!receiverId || !receiverRole) {
        return next(new AppError('Receiver ID and role are required', 400));
    }
